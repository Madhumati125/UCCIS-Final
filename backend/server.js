...
// =====================================================
//
// Keep ONE MongoDB connection in server.js.
// Render must provide MONGO_URI as an environment variable.
// Locally, if MONGO_URI is missing, the server still starts so that
// non-Mongo UCCIS APIs can be tested.
...
const connectMongoDB = async () => {
    ...
    try {
        ...
        // Do not kill the Render process immediately. This allows
        // /health and non-Mongo APIs to remain available and makes
        // the actual configuration problem visible in the logs.
        console.error(
            "Set MONGO_URI in the Render Environment Variables if MongoDB is required."
        );
    }
};

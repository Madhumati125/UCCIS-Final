          ...
          <tbody>
            ...
            {backendResponse.map((item) => (
              <tr key={item.reportId}>
                <td style={{ color: "#000000" }}>{item.reportId}</td>
                <td style={{ color: "#000000" }}>{item.category}</td>
                <td style={{ color: "#000000" }}>{item.generated}</td>
                <td style={{ color: "#000000" }}>{item.records}</td>
              </tr>
            ))}

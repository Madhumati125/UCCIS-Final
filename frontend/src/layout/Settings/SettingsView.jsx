      ...
      <div className="card">
        ...
        <table className="uccis-table">
          ...
          <tbody>
            ...
            <tr>
              <td style={{ color: "#000000" }}>Signals Engine</td>
              <td style={{ color: "#000000" }}>Running</td>
              <td style={{ color: "#000000" }}>99.8%</td>
              <td style={{ color: "#000000" }}>45 Days</td>
            </tr>

            <tr>
              <td style={{ color: "#000000" }}>Replay Engine</td>
              <td style={{ color: "#000000" }}>Running</td>
              <td style={{ color: "#000000" }}>99.9%</td>
              <td style={{ color: "#000000" }}>45 Days</td>
            </tr>

            <tr>
              <td style={{ color: "#000000" }}>Evidence Engine</td>
              <td style={{ color: "#000000" }}>Running</td>
              <td style={{ color: "#000000" }}>98.7%</td>
              <td style={{ color: "#000000" }}>45 Days</td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ color: "#000000" }}>Running</td>
              <td style={{ color: "#000000" }}>99.5%</td>
              <td style={{ color: "#000000" }}>45 Days</td>
            </tr>

            <tr>
              <td style={{ color: "#000000" }}>Runtime Engine</td>
              <td style={{ color: "#000000" }}>Running</td>
              <td style={{ color: "#000000" }}>99.9%</td>
              <td style={{ color: "#000000" }}>45 Days</td>
            </tr>

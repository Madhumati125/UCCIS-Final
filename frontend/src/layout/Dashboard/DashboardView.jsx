  ...
  return (
    <RebuildSprint>
      ...
      <div className="card">
        ...
        <table className="uccis-table" style={{ color: "#000000" }}>
          <thead>
            <tr>
              <th>Incident ID</th>
              <th>Trace ID</th>
          ...
          <tbody>
            {incidents.map((item) => (
              <tr key={item.id}>
                ...
                <td style={{ color: "#000000" }}>{item.trace}</td>
                <td style={{ color: "#000000" }}>{item.severity}</td>
          ...
          <tbody>
            {escalations.map((item) => (
              <tr key={item.id}>
                ...
                <td style={{ color: "#000000" }}>{item.assigned}</td>
                <td style={{ color: "#000000" }}>{item.status}</td>
              </tr>
            ))}
          </tbody>

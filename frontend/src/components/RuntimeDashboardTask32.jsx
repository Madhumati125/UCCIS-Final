      ...
      <div className="main-content">
        ...
        {activePanel === "dashboard" && (
          <>
            ...
            <div className="cards">
              <StatCardTask32 title="Signals" value={cards.signals} />
              <StatCardTask32 title="Telemetry" value={cards.telemetry} />
              <StatCardTask32 title="Incidents" value={cards.incidents} />
              <StatCardTask32 title="Escalations" value={cards.escalations} />
            </div>
        ...
        {activePanel === "runtime" && (
          <div className="drilldown-panel">
            ...
            {/* METRICS */}
            <div className="cards">
              <StatCardTask32 title="Status" value={cards.runtimeHealth} />
